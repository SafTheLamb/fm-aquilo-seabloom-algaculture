...
local BAY_CRANE_SCALE = 2/3

return {
    origin = {0.5 * BAY_CRANE_SCALE, -0.55 * BAY_CRANE_SCALE, 2.567},
    ...
    min_arm_extent = 0.0,
    min_grappler_extent = 0.2 * BAY_CRANE_SCALE,
    operation_angle = 10,--in degrees
    telescope_default_extention = 0.5 * BAY_CRANE_SCALE,
    ...
    parts = {
      {
        ...
        static_length = {0.0, 0.0, 0.88 * BAY_CRANE_SCALE },
        snap_start = 1.0 * BAY_CRANE_SCALE,
        snap_end = 1.0 * BAY_CRANE_SCALE,
      ...
      },
      {
        ...
        layer = -1,
        should_scale_for_perspective = false,
        relative_position = {0.0, 0.45 * BAY_CRANE_SCALE, 0.0 },
        extendable_length = {0.0, 0.0, 0.0 }, --tg(37.3)
        static_length = {0.0, 1.0 * BAY_CRANE_SCALE, 1.0 * 0.76179585 * BAY_CRANE_SCALE},
        snap_start = 1.0 * BAY_CRANE_SCALE,
        snap_end = 0.7 * BAY_CRANE_SCALE,
        dying_effect = default_dying_effect,
        name = "arm_inner"
      },
      {
        ...
        layer = 2,
        should_scale_for_perspective = false,
        relative_position = {0.0, 0.4 * BAY_CRANE_SCALE, 0.4 * 0.76179585 * BAY_CRANE_SCALE + 0.1 * BAY_CRANE_SCALE },
        extendable_length = {0.0, 0.0, 0.0 * 0.1228 * BAY_CRANE_SCALE }, -- tg(7°)
        static_length = {0.0, 1.6 * BAY_CRANE_SCALE, 1.6 * 0.1228 * BAY_CRANE_SCALE},
        snap_start = 0.8 * BAY_CRANE_SCALE,
        snap_end = 0.5 * BAY_CRANE_SCALE,
        snap_end_arm_extent_multiplier = 0.1 * BAY_CRANE_SCALE,
        dying_effect = default_dying_effect,
      ...
      },
      {
        ...
        rotated_sprite_shadow = util.sprite_load("__space-age__/graphics/entity/agricultural-tower/agricultural-tower-crane-5-shadow", {
          priority = "very-low",
          direction_count = 32,
          scale = 1 * BAY_CRANE_SCALE,
          draw_as_shadow = true
        }),
        rotated_sprite_reflection = util.sprite_load("__space-age__/graphics/entity/agricultural-tower/agricultural-tower-crane-5-reflection", {
          priority = "very-low",
          direction_count = 8,
          scale = 5 * BAY_CRANE_SCALE
        }),
        is_contractible_by_cropping = true,
        relative_position = {0.0, -1.5 * BAY_CRANE_SCALE, -1.5 * 0.1228 * BAY_CRANE_SCALE},
        extendable_length = {0.0, 4.5 * BAY_CRANE_SCALE, 4.5 * 0.1228 * BAY_CRANE_SCALE }, -- tg(7°)
        static_length = {0.0, 1.4 * BAY_CRANE_SCALE, 1.4 * 0.1228 * BAY_CRANE_SCALE},
        snap_start = 0.7 * BAY_CRANE_SCALE,
        snap_end = 0.3 * BAY_CRANE_SCALE,
        dying_effect = default_dying_effect,
        name = "arm_central"
      },
      {
        ...
        rotated_sprite_shadow = util.sprite_load("__space-age__/graphics/entity/agricultural-tower/agricultural-tower-crane-6-shadow", {
          priority = "very-low",
          direction_count = 32,
          scale = 1 * BAY_CRANE_SCALE,
          draw_as_shadow = true
        }),
        rotated_sprite_reflection = util.sprite_load("__space-age__/graphics/entity/agricultural-tower/agricultural-tower-crane-6-reflection", {
          priority = "very-low",
          direction_count = 8,
          scale = 5 * BAY_CRANE_SCALE
        }),
        ...
        relative_position = {0, -0.2 * BAY_CRANE_SCALE, 0.3 * 0.1228 * BAY_CRANE_SCALE},
        extendable_length = {0, 0, 0 },
        static_length = {0, 0.7 * BAY_CRANE_SCALE, -0.7 * 0.1944 * BAY_CRANE_SCALE }, --tg(-11°)
        snap_start = 0.3 * BAY_CRANE_SCALE,
        snap_end = 0.2 * BAY_CRANE_SCALE,
        snap_end_arm_extent_multiplier = 0.05 * BAY_CRANE_SCALE,
        dying_effect = default_dying_effect,
      ...
      },
      {
        ...
        layer = 0,
        is_contractible_by_cropping = true,
        relative_position = {0.0, -0.5 * BAY_CRANE_SCALE, 0.5 * 0.1944 * BAY_CRANE_SCALE},
        extendable_length = {0, 4 * BAY_CRANE_SCALE, -4 * 0.1944 * BAY_CRANE_SCALE }, --tg(11°)
        static_length = {0, 1.9 * BAY_CRANE_SCALE, -1.9 * 0.1944 * BAY_CRANE_SCALE },
        snap_start = 0.3 * BAY_CRANE_SCALE,
        snap_end = 0.0,
        dying_effect = default_dying_effect,
        name = "arm_outer"
      },
      {
        ...
        layer = -1,
        relative_position = {0.0, 0.0, -0.17 * BAY_CRANE_SCALE },
        static_length_grappler = {0, 0, -0.6 * BAY_CRANE_SCALE },
        dying_effect = default_dying_effect,
        name = "grappler-hub"
      },
      {
        ...
        layer = -2,
        relative_position = {0.0, 0.0, 0.0 },
        static_length_grappler = {0, 0, -0.5*BAY_CRANE_SCALE},
        extendable_length_grappler = {0, 0, -4*BAY_CRANE_SCALE},
        dying_effect = default_dying_effect,
        name = "telescope"
      },
      {
        ...
        should_scale_for_perspective = false,
        relative_position = {0.0, 0.0, 0.0 },
        static_length_grappler = {0, 0, -0.75 * BAY_CRANE_SCALE },
