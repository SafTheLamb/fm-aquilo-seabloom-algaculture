...
data:extend({
	...
	},
	{
		...
		results = {
			{type="item", name="seabloom", amount=2, independent_probability=0.06},
	...
	},
	{
		...
		categories = {mods["wood-industry"] and "kiln-smelting" or "smelting"},
		subgroup = subgroup,
	...
	},
	{
		...
		results = {
			{type="item", name="seabloom", amount=3, independent_probability=0.66},
	...
	},
	{
		type = "recipe",
		name = "seaweed-snack",
		categories = mods["wood-industry"] and {"organic", "kiln-smelting"} or {"organic"},
		subgroup = subgroup,
