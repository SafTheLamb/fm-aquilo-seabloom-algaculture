...
if settings.startup["seabloom-modify-vanilla"].value then
	...
	frep.add_result("ammoniacal-solution-separation", {type="item", name="seaweed", amount=1, independent_probability=0.49})
	frep.add_result("ammoniacal-solution-separation", {type="item", name="seabloom", amount=1, independent_probability=0.01})
